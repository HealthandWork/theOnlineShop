...
public class SalesItem {
    private String name;
    private int price, antal;  // in cents
    ...
    public SalesItem(String name, int price, int antal) {
        this.name = name;
        this.price = price;
        this.antal = antal;
        comments = new ArrayList<>();
    ...
    public void showInfo() {
        ...
        System.out.println("Total worth of storage: $" + totalValueStorage() + ".");
    ...
    public int ratingAverage() {
        ...
        for (Comment rating : comments ) {

            value = value + rating.getRating();

        }

        average = value / getNumberOfComments();
